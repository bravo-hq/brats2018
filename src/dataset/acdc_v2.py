...
class ACDC(Dataset):
    def __init__(
        ...
        self.p = p
        whole_data_raw = load_dataset(ids=range(101), root_dir=data_root) # it has been hardcoded to load 100 patients
    ...
    def split_dataset(self, patients_dir):
        ...
        if self.mode == "tr":
            ...
            self.patients_data["img"] = patients_dir["img"][te_index : te_index + vl_index]
            self.patients_data["seg"] = patients_dir["seg"][te_index : te_index + vl_index]
